...
\textit{Luz e Carlor}, 1ª ed., 1696, pp. 271--272 \textsc{xviii}. [\versal{N.\,A.}]}
\end{hedraquote}
...
\textsc{xxxvii}. [\versal{N.\,A.}]} sendo tal a sua nomeada, ainda entre os protestantes,
...
\textit{Sermões e práticas}, 1ª ed., de 1762. Parte \textsc{i}, p.~297. [\versal{N.\,A.}]}
...
\textit{Homo nascitur ad laborem}.\footnote{ Jó, \textsc{v}, 7. [\versal{N.\,A.}]} 
...
\begin{verse}
\textit{In picciol tempo gran dottor si feo}\footnote[*]{\emph{Paradiso, \textsc{xii}, 85.} [\versal{N.\,A.}]}\footnote{``Em pouco tempo grão doutor se fez''.}
\end{verse}
...
8. [\versal{N.\,A.}]} Quereria dizer: Boa é a lei quando executada com retidão.
...
\textit{Nullo}\footnote[*]{Dante: \emph{Purgatório}, \textsc{xvi}, 97--98. [\versal{N.\,A.}]}\footnote{``As leis aí estão, mas quem as vai reger?
Ninguém.''}
\end{verse}
...
est.}\footnote[*]{ Lucas, \textsc{xvi}, 10. [\versal{N.\,A.}]}\footnote{“Quem é fiel nas coisas mínimas também o é nas maiores; e quem é injusto nas
...
\textsc{xix}, 15. [\versal{N.\,A.}]} Bem praticou esta virtude Canuto, rei dos Vândalos, que, mandando
...
M.~Bernardes: \textit{Sermões}, Parte \textsc{i}, pp. 263--264. [\versal{N.\,A.}]}
